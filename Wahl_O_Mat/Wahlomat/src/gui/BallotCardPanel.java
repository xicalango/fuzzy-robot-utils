...
public class BallotCardPanel extends JPanel {
	...
	private VotePanel<DCandidate> firstVote;
	private VotePanel<PartyList> secondVote;
	...
	public BallotCardPanel(BallotCard ballotCard){
		...
		firstVote = VotePanelFabric.getFirstVotePanel(ballotCard);			

		secondVote = VotePanelFabric.getSecondVotePanel(ballotCard);		
	...
	public DCandidate getFirstVote() throws NoVotePerformedException{
		return this.firstVote.getVote();
	}
	
	public PartyList getSecondVote() throws NoVotePerformedException{
		return this.secondVote.getVote();
	}
